...
| File                                                       |Description|
|------------------------------------------------------------|-|
| `LRR Logistic Regression Model.py`                         |Full pipeline: cleaning, modeling, diagnostics, scaling, export|
| `single_family_loan_level_dataset_curated_predictions.csv` |Full dataset with predicted default and probability score|
